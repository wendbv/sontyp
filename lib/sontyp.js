...
class Type {
    ...
    parseAdditionals() {
        this.additionals = this.additionalsItems
            .map((t) => {
                t.convert();
                return t.inline;
            })
...
class TString extends Type {
    inlinify() {
        ...
        // Check if this string is actually a enum
        if(this.object.enum){
            this.inline = `'${this.object.enum.join("' | '")}'`;
        } else {
            this.inline = 'string';
        }
    }
    ...
    convert() {
        ...
        try{
            ...
            if(typeof referenced === 'undefined') {
                console.log(error);
                console.log('Sontyp Error: This referenced type was not found:');
...
class Sontyp {
    ...
    parseSchema(schema) {
        ...
        if(typeof type === 'undefined') {
            type = new TAny(this, schema);
            console.log('Sontyp Warning: "any" type detected in schema:\n',
                        schema);
        }
